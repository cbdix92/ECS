...
namespace CMDR.Systems
{
    public static class Camera
    {
        ...
        /// <summary>
        /// Determines if the Camera View Matrix needs to be recalculated.
        /// </summary>
        public static bool ChangeViewState { get; private set; }

        /// <summary>
        /// Determines if the Camera Projection Matrix needs to be recalculated.
        /// </summary>
        ...
        /// <summary>
        /// Test if the Camera is colliding with an object.
        /// </summary>
        /// <param name="transform"> The Transform associated with an object. </param>
        /// <param name="collider"> The Collider associated with an object. </param>
        /// <returns> Returns True if the object is colliding; otherwise returns False. </returns>
        internal static bool CameraRectTest(Transform transform, Collider collider)
        {
            throw new NotImplementedException("CameraRectTest");
        }
