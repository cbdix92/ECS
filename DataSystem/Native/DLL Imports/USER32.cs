...
namespace CMDR.Native
{
    internal static partial class Win
    {
		...
		public static extern LRESULT CallNextHookEx(IntPtr hhk, int nCode, IntPtr wParam, IntPtr lParam);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern LRESULT DefWindowProcW(HWND hWnd, uint Msg, IntPtr wParam, IntPtr lParam);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern int GetMessage(ref MSG lpMsg, HWND hWnd, uint wMsgFilterMin, uint wMsgFilterMax);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern bool GetMonitorInfoW(IntPtr hMonitor, [MarshalAs(UnmanagedType.LPStruct)] ref MONITORINFOEXW lpmi);
		...
		[DllImport(User32, SetLastError = true)]	
		public static extern uint GetRawInputDeviceInfoW(IntPtr hDevice, RIDI uiCommand, IntPtr pData, ref uint pcbSize);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern uint GetRawInputDeviceList(RAWINPUTDEVICELIST[] pRawInputDeviceList, ref uint puiNumDevices, uint cbSize);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern uint GetRegisteredRawInputDevices(RAWINPUTDEVICE[] pRawInputDevices, ref uint puiNumDevices, uint cbSize);

		[DllImport(User32, SetLastError = true)]
		public static extern IntPtr LoadCursorW(IntPtr hInstance, ushort lpCursorName);

		[DllImport(User32, SetLastError = true)]
		public static extern IntPtr LoadIconW(IntPtr hInstance, ushort lpIconName);

		[DllImport(User32, SetLastError = true)]
		public static extern IntPtr LoadImageW(IntPtr hInstance, string name, uint type, int cx, int cy, LR fuLoad);

		[DllImport(User32, SetLastError = true)]
		public static extern bool PeekMessageW(ref MSG lpMsg, HWND hwnd, uint wMsgFilterMin, uint wMsgFilterMax, PM wRemoveFlag);

		[DllImport(User32, SetLastError = true)]
		public static extern bool PostMessageW(HWND hWnd, uint Msg, IntPtr wParam, IntPtr lParam);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern ATOM RegisterClassExW(/*[MarshalAs(UnmanagedType.LPStruct)]*/[In] ref WNDCLASSEXW wnd);
		...
		[DllImport(User32, SetLastError = true)]
		public static extern HHOOK SetWindowsHookExW(WH idHook, HookProc lpfn, IntPtr hmod, uint dwThreadID);
