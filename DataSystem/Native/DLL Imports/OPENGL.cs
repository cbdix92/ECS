...
namespace CMDR.Native
{
    internal static partial class Win
    {
        ...
        [DllImport(OpenGL, SetLastError = true)]
        internal static extern int wglGetLayerPaletteEntries(HDC hdc, int iLayerPlane, int index , int nPallette , ref uint colorRef);
        ...
        [DllImport(OpenGL, SetLastError = true)]
        internal static extern bool wglUseFontOutlinesW(HDC hdc, uint first, uint count, uint listBase, float deviation, float extrusion, int format, [MarshalAs(UnmanagedType.LPStruct)] ref GLYPHMETRICSFLOAT gmf);
