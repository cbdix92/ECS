...
namespace CMDR.Native
{
    internal static partial class Win
    {
        ...
        public static extern bool wglCopyContext(HGLRC hglrc1, HGLRC hglrc2, uint hglrcSrc );
        ...
        [DllImport(OpenGL, SetLastError = true)]
        public static extern HGLRC wglCreateLayerContext(HDC hdc, int layerPlane);
        ...
        [DllImport(OpenGL, SetLastError = true)]
        public static extern bool wglDescribeLayerPlane(HDC hdc, int iLayer, int iLayerPlane, uint nSize, [MarshalAs(UnmanagedType.LPStruct)]LAYERPLANEDESCRIPTOR lpd);
        ...
        /// If the function fails or when no pixel format is selected, the return value is zero. </returns>
        /// <see href="https://docs.microsoft.com/en-us/windows/win32/api/wingdi/nf-wingdi-wglgetlayerpaletteentries"> MICROSOFT DOCS </see>
        [DllImport(OpenGL, SetLastError = true)]
        public static extern int wglGetLayerPaletteEntries(HDC hdc, int iLayerPlane, int index , int nPallette , ref uint colorRef);
        ...
        [DllImport(OpenGL, SetLastError = true)]
        public static extern int wglSetLayerPaletteEntries(HDC hdc, int iLayerPlane, int iStart, int nSize, ref uint colorRef);
        ...
        [DllImport(OpenGL, SetLastError = true)]
        public static extern bool wglUseFontBitmapsW(HDC hdc, uint firstGlyph, uint nGlyphs, uint start);
        ...
        /// <returns> When the function succeeds, the return value is TRUE. When the function fails, the return value is FALSE and no display lists are generated. </returns>
        /// <see href="https://docs.microsoft.com/en-us/windows/win32/api/wingdi/nf-wingdi-wglusefontoutlinesw"> MICROSOFT DOCS </see>
        [DllImport(OpenGL, SetLastError = true)]
        public static extern bool wglUseFontOutlinesW(HDC hdc, uint first, uint count, uint listBase, float deviation, float extrusion, int format, [MarshalAs(UnmanagedType.LPStruct)] ref GLYPHMETRICSFLOAT gmf);
    }
}