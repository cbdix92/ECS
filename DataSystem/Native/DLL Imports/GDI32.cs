...
namespace CMDR.Native
{
    internal static partial class Win
    {
        ...
        public static extern int ChoosePixelFormat(HDC hdc, [MarshalAs(UnmanagedType.LPStruct)] [In] PIXELFORMATDESCRIPTOR ppfd);
        ...
        [DllImport(GDI32, SetLastError = true)]
        public static extern bool SetPixelFormat(HDC hdc, int format, [MarshalAs(UnmanagedType.LPStruct)] PIXELFORMATDESCRIPTOR ppfd);
    }
}