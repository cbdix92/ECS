...
namespace CMDR.Native
{
	...
	internal struct WNDCLASSEXW
	{
		...
		public WNDCLASSEXW(uint cbSize, uint style, WNDPROC lpfnWndProc, int cbClsExtra, int cbWndExtra, IntPtr hInstance,
		...
		public static WNDCLASSEXW Create()
		{
			...
			wndClass.cbSize = (uint)Marshal.SizeOf<WNDCLASSEXW>(wndClass);
			return wndClass;
		}
	}
}
